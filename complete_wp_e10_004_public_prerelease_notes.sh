...
# Complete WP-E10-004 — Draft public pre-release notes.
#
# This script creates:
...
cat > docs/release/PUBLIC-PRERELEASE-NOTES.md <<'EOF'
---
...
cat > work/deliverables/E10/WP-E10-004-public-prerelease-notes.md <<'EOF'
---
...
replacements = {
    "| Public pre-release notes drafted | Pending | WP-E10-004 remains required |": "| Public pre-release notes drafted | Pass | `docs/release/PUBLIC-PRERELEASE-NOTES.md` |",
    "| Public pre-release notes exist. | Pending | WP-E10-004 | Required before any public tag. |": "| Public pre-release notes exist. | Pass | `docs/release/PUBLIC-PRERELEASE-NOTES.md` | Source-only public pre-release notes drafted. |",
    "| Known limitations are documented. | Pending | WP-E10-004 | Should include dry-run-only evolution and no apply behavior. |": "| Known limitations are documented. | Pass | `docs/release/PUBLIC-PRERELEASE-NOTES.md` | Dry-run-only evolution, no apply behavior, no installer/package distribution, and no autonomous runtime are documented. |",
    "WP-E10-004 — Draft public pre-release notes\n": "",
}
...
echo
echo "WP-E10-004 files written:"
echo "  docs/release/PUBLIC-PRERELEASE-NOTES.md"
echo "  work/deliverables/E10/WP-E10-004-public-prerelease-notes.md"
echo
echo "Next verification:"
echo "  git status --short"
echo "  test -f docs/release/PUBLIC-PRERELEASE-NOTES.md"
