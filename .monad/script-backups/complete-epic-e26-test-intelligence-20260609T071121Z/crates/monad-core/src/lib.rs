...
pub use doctor::{
    DoctorCategory, DoctorCheck, DoctorReport, DoctorSeverity, render_doctor_report,
    render_doctor_report_json, run_doctor, run_doctor_for_root,
};
...
pub use release::{
    ...
    ReleasePlanOptions, build_release_plan, render_release_plan, render_release_plan_json,
};
...
pub use upgrade::{
    SUPPORTED_REPOSITORY_CONTRACT_VERSION, UpgradeApplyResult, UpgradePlan, UpgradeStatus,
