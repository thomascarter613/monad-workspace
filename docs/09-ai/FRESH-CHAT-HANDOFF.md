...
4. `.monad/context/work-packet-handoffs/WP-E1-010.md`
5. `work/epics/E1-runtime-foundation.md`
6. `work/packets/E1/WP-E1-010-establish-runtime-output-formatting-foundation.md`
7. `crates/monad-core/src/output.rs`
...
WP-E1-010 adds Output Formatting.
