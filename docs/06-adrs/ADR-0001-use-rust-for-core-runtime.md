...
This document is the canonical Monad location for the **ADR 0001: Use Rust For Core Runtime** topic within the **Architecture Decision Records** documentation area.
