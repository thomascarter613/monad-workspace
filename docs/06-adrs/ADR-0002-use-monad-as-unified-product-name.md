...
This document is the canonical Monad location for the **ADR 0002: Use Monad As Unified Product Name** topic within the **Architecture Decision Records** documentation area.
