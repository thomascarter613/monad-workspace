...
This document is the canonical Monad location for the **ADR 0005: Use Multi Crate Rust Workspace** topic within the **Architecture Decision Records** documentation area.
