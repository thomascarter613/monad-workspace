...
This document is the canonical Monad location for the **ADR 0007: Use Supervised Autonomy For Agent Workflows** topic within the **Architecture Decision Records** documentation area.
